...
class Autograder_4_2(Base_Autograder):
    ...
    def __init__(self):
        ...
        self.test_in_files =     os.path.join("/home/doan0016/", "test_data", "Problem_1_and_2")
        self.test_out_files =    os.path.join("/home/doan0016/", "test_data", "Problem_2")
...
def main():
    print("{G}Autograding for Project 4 Problem 2:\n{W}")
